    ...
    <div className="bg-white">
      <div>
              ...
              <form className="mt-4 border-t border-gray-200">
                ...
                <ul role="list" className="px-2 py-3 font-medium text-gray-900">
                  {Lists.map((el) => {
                    return (
                      <li key={el.slug}>
                        <a href={el.slug} className="block px-2 py-3">
                          {el.title}
                        </a>
                      </li>
                    );
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="items-baseline border-b border-gray-200 pb-6 pt-24 grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
